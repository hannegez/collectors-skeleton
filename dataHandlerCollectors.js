...
//Här var tanken att de olika kvartalen skulle "ladda" de olika knapparna med number of actions
          ...
          Data.prototype.resetSecondQuarterPlacements = function(room) {
            ...
            Data.prototype.resetThirdQuarterPlacements = function(room) {
              ...
              Data.prototype.resetFourthQuarterPlacements = function(room) {
                ...
                // HÄR VILL VI ATT KORTEN SKA FLYTTAS VID EN QUARTER
                Data.prototype.nextQuarter = function (roomId) {
                  let room = this.rooms[roomId];
                  if (typeof room !== 'undefined') {
                    room.quarter ++;
                      ...
                      if (typeof room !== 'undefined') {
                        if (typeof room.players[playerId] !== 'undefined') {
                          ...
                          room.players[playerId] = { hand: [],
                            ...
                            items: [],
                            itemCounter:  {
                              fastaval:       { image: '/images/item_fastaval.png',
                              value: 0 },
                            ...
                            skillCounter:  {
                              workerIncome:   { image: '/images/skills_workerIncome.png',
                              value: 0 },
                            ...
                            skillCounter_VP: {
                              vp_fastaval:     { image: '/images/skills_VP-fastaval.png',
                              value: 0 },
